...
public class _BlackList {
    ...
    public static long isMutedTill(int userID, String UUID) {
        ...
        BlockData blockUserID = findBlock(userID + "", TYPE_USER_ID, REASON_GHOST);

        BlockData blockUUID = findBlock(UUID, TYPE_UUID, REASON_GHOST);
        ...
        return blockedTill + (blockedTimes * (_Config.ONE_HOUR * 2));
    }

    private static BlockData findBlock(String property, String type, String reason) {
        ...
        if (property != null){
            ...
            Utilities.lock(TAG, LOCK.readLock(), () -> {
                ...
                for (BlockData loopingBlock : BLOCKS) {
    ...
    public static void addIPAddress(int reporterID, String ipAddress, String reason, String payload) {
        ...
        String insertStatement = "INSERT " + _Config.TABLE_BLACK_LIST +
    ...
    public static void addUserID(int reporterID, int targetID, String reason, String payload) {
        ...
        String insertStatement = "INSERT " + _Config.TABLE_BLACK_LIST + " (" + FIELD_PROPERTY + ", " +
        ...
        _DatabaseOld.insert(TAG, insertStatement, parameters, (wasSuccessful, generatedID, error) -> {
            ...
            BlockData lastBlock = findBlock(targetID + "", TYPE_USER_ID, reason);
    ...
    private static int isStillBocked(String reason, int blockedTimes, long lastBlockTime) {
        ...
        if (REASON_WARN.equals(reason)) {
            ...
            long blockDuration = blockedTimes * _Config.FIVE_MINUTES;
        ...
        if (REASON_GHOST.equals(reason)) {
            ...
            long blockDuration = blockedTimes * _Config.ONE_HOUR * 2;
        ...
        if (REASON_BAN.equals(reason)) {
            ...
            if (System.currentTimeMillis() - _Config.ONE_DAY * 7 < lastBlockTime) return STATE_BANNED;
        }

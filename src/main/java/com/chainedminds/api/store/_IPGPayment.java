...
public class _IPGPayment<IPGTransactionData extends _IPGTransactionData,
        ProductData extends _ProductData> extends _Payment<ProductData> {

    private static final String TAG = _IPGPayment.class.getSimpleName();
    ...
    public _IPGTransactionData prepareOrderPayment(IPGTransactionData ipgTransaction) {
    ...
    public _IPGTransactionData generatePaymentLink(String appName, _IPGTransactionData transaction) {
    ...
    public _IPGTransactionData generatePasargadPaymentLink(_IPGTransactionData transaction) {
    ...
    public static _IPGTransactionData generateZarinPalPaymentLink(_IPGTransactionData transaction) {
    ...
    public boolean addTransaction(_IPGTransactionData transaction) {
        ...
        String statement = "INSERT INTO " + _Config.TABLE_PURCHASES_IPG + " (" +
    ...
    public int addArbitraryData(String gateway, Map<String, String> arbitraryData) {
        ...
        switch (gateway) {
            ...
            case "Pasargad":
                ...
                table = _Config.TABLE_PURCHASES_IPG_PASARGAD;
            ...
            case "ZarinPal":
                ...
                table = _Config.TABLE_PURCHASES_IPG_ZARINPAL;
    ...
    public IPGTransactionData getTransaction(String orderID) {
        ...
        String statement = "SELECT * FROM " + _Config.TABLE_NAME_PURCHASES_IPG + " WHERE " + FIELD_ORDER_ID + " = ?";
    ...
    public IPGTransactionData getTransaction(String gateway, Map<String, String> arbitraryData) {
        ...
        String statement = "SELECT * FROM " + _Config.TABLE_NAME_PURCHASES_IPG + " AS T1" +
    ...
    public boolean updatePurchaseState(Connection connection, int id, int state) {
        ...
        String updateStatement = "UPDATE " + _Config.TABLE_PURCHASES_IPG_PRODUCTS +
    ...
    private IPGTransactionData readTransaction(ResultSet resultSet) throws Exception {
        ...
        IPGTransactionData ipgTransaction = (IPGTransactionData) _Classes
                .construct(_Classes.getInstance().ipgTransactionClass);

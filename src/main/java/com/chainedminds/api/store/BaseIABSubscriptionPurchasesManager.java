...
public class BaseIABSubscriptionPurchasesManager<IABTransactionData extends BaseIABTransactionData> {

    private static final String TAG = BaseIABSubscriptionPurchasesManager.class.getSimpleName();
    ...
    public void checkSubscriptions() {
        ...
        String selectStatement = "SELECT * FROM " + BaseConfig.TABLE_PURCHASES_IAB_SUBSCRIPTIONS +
        ...
        for (BaseIABTransactionData iabTransaction : subscriptionsList) {

            Boolean verified = BaseResources.getInstance().iabPaymentManager.verifyIABTransaction(iabTransaction);
    ...
    public int addIABTransaction(IABTransactionData transaction) {
        ...
        String statement = "INSERT " + BaseConfig.TABLE_PURCHASES_IAB_SUBSCRIPTIONS +
    ...
    public Set<Integer> getActiveSubscribers() {
        ...
        String selectStatement = "SELECT DISTINCT " + FIELD_USER_ID + " FROM " +
                BaseConfig.TABLE_PURCHASES_IAB_SUBSCRIPTIONS + " WHERE " + FIELD_STATE +
    ...
    public boolean updateTransactionState(Connection connection, int id, int state, long purchaseDate, long expirationDate) {
        ...
        String updateStatement = "UPDATE " + BaseConfig.TABLE_PURCHASES_IAB_SUBSCRIPTIONS +

...
public class _IPGSubscriptionPurchase<IPGTransactionData extends _IPGTransactionData> {

    private static final String TAG = _IPGSubscriptionPurchase.class.getSimpleName();
    ...
    public boolean updateTransactionState(Connection connection, int id, int state, long purchaseDate, long expirationDate) {
        ...
        String updateStatement = "UPDATE " + _Config.TABLE_PURCHASES_IPG_SUBSCRIPTIONS +

...
public class _IPGProductPurchase<IPGTransactionData extends _IPGTransactionData> {

    private static final String TAG = _IPGProductPurchase.class.getSimpleName();

...
public class _IABPayment<
    ...
    public void start() {
        ...
        Task.add(Task.Data.build()
                ...
                .setTime(0, 0, 0)
                .setInterval(1, 0, 0, 0)
                .onEachCycle(() -> _R.get().iabSubscriptionPurchase.checkSubscriptions())
                .schedule());
    }
    ...
    private void checkPendingTransactions() {
        ...
        pendingTransactionsList.addAll(_R.get()
    ...
    public Boolean verifyIABTransaction(_IABTransactionData transaction) {
        ...
        ProductData originalProduct = (ProductData) _R.get().product.getProduct(market, sku);
        ...
        if (verified.get() != null) {
            ...
            if (_Product.CATEGORY_PRODUCT.equals(productCategory)) {
                ...
                wasSuccessful = _R.get().iabProductPurchase
                        .updateTransactionState(null, transaction.id, transaction.state);
            }

            if (_Product.CATEGORY_SUBSCRIPTION.equals(productCategory)) {

                wasSuccessful = _R.get().iabSubscriptionPurchase
                        .updateTransactionState(null, transaction.id, transaction.state,
        ...
        new Thread(() -> {
            ...
            synchronized (transaction.userID + "") {
                ...
                try {
                    ...
                    ProductData originalProduct = (ProductData) _R.get()
